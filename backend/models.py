...
class Format(Base):
    ...
    guideLinesJpeg: Mapped[str] = mapped_column(String(600), nullable=False, default="")
    guideLinespsd: Mapped[str] = mapped_column(String(600), nullable=False, default="")
    guideLineslndd: Mapped[str] = mapped_column(String(600), nullable=False, default="")
    text1: Mapped[str] = mapped_column(Text, nullable=True)
    text2: Mapped[str] = mapped_column(Text, nullable=True)
    text3: Mapped[str] = mapped_column(Text, nullable=True)
